...
def getCalendars():
    ...
    response = requests.get(calendarListUrl, headers={'Authorization':'OAuth '+access_token, 'Content-Type': 'application/json'})
...
def getEvent(event_id):
    ...
    response = requests.get(eventUrl, headers={'Authorization':'OAuth '+access_token, 'Content-Type': 'application/json'})
    response = response.json()
    print "response: ", response
...
def getAllEvents():
    ...
    response = requests.get(allEventsUrl, headers={'Authorization':'OAuth '+access_token, 'Content-Type': 'application/json'})
    response = response.json()
    print "response: ", response
